...
Those are all sensing coverage problem$^{1,3}$.
...
\footnotetext[1]{aura Krick, Mireille E. Broucke \& Bruce A. Francis (2009) Stabilisation of infinitesimally rigid formations of multi-robot networks, International Journal of Control, 82:3, 423-439.}
\footnotetext[2]{K. Oh and H. Ahn, "Distance-based formation control using euclidean distance dynamics matrix: Three-agent case," Proceedings of the 2011 American Control Conference, San Francisco, CA, 2011, pp. 4810-4815.}
\end{frame}
%%
